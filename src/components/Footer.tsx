...
export default function Footer() {
    return (
        <footer className="bg-zinc-900 dark:bg-slate-950 border-t-1 dark:border-slate-700 text-zinc-400 py-8 mt-auto">
            <div className="container mx-auto px-6 text-white dark:text-zinc-400 text-center md:text-left md:flex md:justify-between md:items-center">
                ...
                <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                    ...
                    <div className="flex gap-5">
                        <a
                            href="https://github.com/kevingillispie"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
                        >
                            <svg className="h-5 w-5 hover:text-zinc-200 transition-colors" fill="currentColor" viewBox="0 0 640 640">
                        ...
                        <a
                            href="https://linkedin.com/in/kevinlgillispie"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                        >
